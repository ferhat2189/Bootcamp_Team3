...
public class WebAPI {
    ...
    public String saucelabs_username = "ferhat2189";
    public String saucelabs_accesskey = "0c6d97fd-89b0-4d53-bb96-e57affd54fa5";
    static DataReader dataReader = new DataReader();

    public void openBrowser() throws IOException {
        setUp(false,"saucelabs","OS X","catalina","chrome","85","https://www.libertymutual.com");
    }
...
//        cap.setExperimentalOption("w3c", true);
//        cap.setCapability("platformName", "Windows 10");
//        cap.setCapability("browserVersion", "71.0");
...
/********* Exel REad And Wite Methodes Comented out because of XSSF....
